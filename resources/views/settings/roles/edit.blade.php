...
<div class="bg-white border border-gray-200">
    ...
    <div class="px-6 py-4 flex items-center justify-between border-b border-gray-100">
        <div>
            <h2 class="text-sm font-semibold text-gray-900" style="font-family: Poppins, sans-serif;">Edit Role</h2>
            <p class="text-xs text-gray-500 mt-0.5" style="font-size: 11px;">Update role information and permissions</p>
        </div>
    ...
    <!-- Form -->
    <form id="role-form" action="{{ route('settings.roles.update', $role) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="p-6">
            <!-- Role Information -->
            ...
            <!-- Permission Matrix -->
            <x-ui.permission-matrix-edit :permissions="$role->permissions ?? []" />
        </div>
    </form>
</div>
@endsection
